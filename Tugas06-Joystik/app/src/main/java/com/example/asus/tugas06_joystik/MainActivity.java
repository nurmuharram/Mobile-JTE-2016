package com.example.asus.tugas06_joystik;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickButton (View view){
        ...
        Button btnKanan = (Button) findViewById(R.id.kananbtn);
        Button btnKiri = (Button) findViewById(R.id.kiribtn);
        Button btnAtas = (Button) findViewById(R.id.atasbtn);
        Button btnBawah = (Button) findViewById(R.id.bawahbtn);
